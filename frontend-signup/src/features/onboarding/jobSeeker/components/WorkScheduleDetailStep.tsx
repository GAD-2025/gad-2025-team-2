...
export function WorkScheduleDetailStep({
  ...
  return (
    <div className="mx-auto flex min-h-screen w-full max-w-[420px] flex-col bg-white px-4 pb-10 pt-8">
      ...
      <div className="mb-6">
        <h1 className="mb-2 text-xl font-semibold text-gray-900">근무 가능 요일 / 시간</h1>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              {startTime && endTime ? (
                ...
                <span className="text-base text-gray-400">시간을 선택해주세요</span>
              )}
            </div>
          ...
          <div className="mt-2 rounded-2xl border border-gray-200 bg-white p-4">
            <div className="mb-4 flex items-center gap-4">
              <div className="flex-1">
                <label className="mb-2 block text-xs text-gray-500">시작 시간</label>
                <select
                  value={startTime || ''}
              ...
              <div className="flex-1">
                <label className="mb-2 block text-xs text-gray-500">종료 시간</label>
                <select
                  value={endTime || ''}
