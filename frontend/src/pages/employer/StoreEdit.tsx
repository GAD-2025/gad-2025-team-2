...
import { getStore, updateStore, type StoreCreatePayload } from '@/api/endpoints';
...
export const StoreEdit = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await updateStore(userId, storeId, payload);
  ...
  return (
    <div className="min-h-screen bg-background pb-24">
      <Header title="가게 정보 수정" showBack />
